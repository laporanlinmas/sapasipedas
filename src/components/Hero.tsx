...
export default function Hero() {
  ...
  return (
    <section className="relative pt-24 pb-20 md:pt-32 md:pb-24 overflow-hidden flex flex-col items-center justify-center min-h-[85vh]">
      ...
      <div className="absolute bottom-10 left-[40%] w-64 h-64 rounded-full bg-amber-500/10 dark:bg-amber-500/5 blur-[80px] pointer-events-none -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full relative z-10 text-center">
        ...
        <div className="flex flex-col items-center justify-center mb-6">
          <div className="relative group">
            <div className="absolute -inset-2.5 rounded-3xl bg-gradient-to-br from-blue-600/30 to-amber-500/20 blur-xl opacity-50 group-hover:opacity-80 transition duration-500" />
        ...
        <div className="max-w-4xl mx-auto mb-10">
          ...
          {/* Badge SI-PEDAS (Kuning Emas) */}
          <div className="inline-flex items-center justify-center mb-4">
            <div className="px-5 py-1.5 bg-amber-50/50 dark:bg-slate-800/50 backdrop-blur-md border border-amber-200/50 dark:border-amber-900/30 rounded-full shadow-sm">
              <span className="text-lg md:text-xl font-black tracking-[0.15em] text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 via-amber-500 to-yellow-600 dark:from-yellow-400 dark:via-amber-400 dark:to-yellow-500 drop-shadow-sm">
                SI-PEDAS
              </span>
            </div>
          </div>
          
          <p className="text-xs md:text-sm font-bold text-slate-500 dark:text-slate-400 mb-3 uppercase tracking-[0.2em]">
            Sistem Informasi Pedestrian Satlinmas
          </p>
          
          {/* Sapa Pedestrian (Biru) */}
          <h1 className="mb-6">
            <span className="block text-[3.5rem] leading-[1.1] sm:text-7xl md:text-[5.5rem] lg:text-[6.5rem] font-black text-transparent bg-clip-text bg-gradient-to-br from-blue-700 via-blue-600 to-blue-800 dark:from-blue-400 dark:via-blue-500 dark:to-blue-300 tracking-tighter pb-2 drop-shadow-sm">
              Sapa Pedestrian
            </span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/cctv"
            className="group relative inline-flex items-center justify-center gap-3 px-8 py-3.5 bg-blue-600 dark:bg-blue-500 text-white rounded-full font-bold text-sm md:text-base overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-600/20 w-full sm:w-auto"
          >
            ...
            <span className="relative flex items-center gap-2">
              <span className="relative flex h-2.5 w-2.5">
                ...
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-blue-100" />
              </span>
