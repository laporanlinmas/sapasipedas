      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-10 sm:mb-12 gap-5 sm:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            ...
            {offlineCount > 0 && (
              <div className="glass-panel inline-flex items-center gap-2 sm:gap-2.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-red-200 dark:border-red-500/30 bg-red-50/50 dark:bg-slate-800/60 shadow-sm backdrop-blur-md">
                <div className="relative flex h-2 w-2 sm:h-2.5 sm:w-2.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-8 relative">
          {previewCCTVData.map((cctv) => (
            <div key={cctv.id} className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg hover:shadow-xl border border-slate-200 dark:border-slate-800 flex flex-col group relative transform transition-all duration-300 hover:-translate-y-1">
              ...
              >
                ...
                {/* Overlay transparan agar bisa diklik tanpa tertahan iframe YouTube */}
                <div className="absolute inset-0 z-10 bg-transparent" />
                
                {/* Efek Hover: Tombol Perbesar */}
          ...
          {/* Overlay gradien di bawah grid untuk efek memudar ke tombol */}
        ...
        <div className="mt-8 sm:mt-12 flex flex-col items-center justify-center relative z-20">
          ...
          <Link 
            href="/cctv"
            className="inline-flex items-center gap-2 sm:gap-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold shadow-xl shadow-slate-900/20 dark:shadow-white/10 transition-all duration-300 hover:scale-105 hover:bg-blue-600 dark:hover:bg-blue-50 hover:shadow-blue-500/30 group text-sm sm:text-base"
          >
